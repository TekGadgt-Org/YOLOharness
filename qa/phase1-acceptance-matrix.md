...
Local HTTP provider -> runtime -> executor        test/integration.test.mjs: local HTTP provider to runtime to executor preserves the exec bridge contract; PASS (DockerExecutor process double captures version-1 stdin envelope and receipt).
