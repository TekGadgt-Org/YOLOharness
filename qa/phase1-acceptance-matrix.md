...
Cleanup reconciliation ambiguity                   test/integration.test.mjs: not-found versus permission/daemon inspect failure; PASS (ambiguous result is cleanup_unknown).
...
Expired credential preflight                        test/integration.test.mjs: expired credentials refresh before first provider request; PASS.
