...
export class AuthClient {
  constructor(config) { required(config); this.config=config; this.fetch=config.fetch ?? fetch; this.store=config.store; this.refreshing=null; this.lockTimeoutMs=config.lockTimeoutMs ?? 5000; this.beforeReclaimRename=config.beforeReclaimRename; this.onLockContended=config.onLockContended; this.onLockAcquired=config.onLockAcquired; }
