...
export function encodeBootstrap({ prompt, model, deadline, accessToken, expiresAt }) {
  ...
  const payload = JSON.stringify({ version: BOOTSTRAP_VERSION, prompt, model, deadline, accessToken, expiresAt });
