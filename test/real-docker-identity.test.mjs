...
test('same packed npm tool call is RED on 64 MiB tmpfs and GREEN on one measured scratch volume', { skip }, async () => {
  ...
  try {
    ...
    const prompt = 'installed npm 70 MiB';
